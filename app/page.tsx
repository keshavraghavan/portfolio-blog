  ...
  return (
    <section>
      ...
      <p className="mb-6 text-lg tracking-tight">
        ...
        My name is Keshav. When people ask what I do, I instinctively mention my professional role—I work at Citi as an application manager. 
        ...
        {/* this is horrible, i need to use tailwind but lazy */}
        <br /> <br />
